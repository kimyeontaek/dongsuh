...
<jsp:include page="../header.jsp"/>
   ...
   <div id="cs_div2">
   <p id = "slash_red">/</p>
   <p id = "cs_title">문의 내역 상세</p>
   <p class="wave"><img src="http://localhost:8080/dongsuh/cs_image/bg_tit_wave.png"></p>
   </div>
   <form name="csBoard_content" action = "http://localhost:8080/dongsuh/csBoard_update.do" method="post">
   ...
   <table id="csBoard_table1">
      ...
      <tr>
         ...
         <a href = "http://localhost:8080/dongsuh/csBoard_delete.do?no=${no}&rpage=${rpage}">
