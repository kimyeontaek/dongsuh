...
<jsp:include page="../header.jsp"/>
   ...
   <p class="wave"><img src="http://localhost:8080/dongsuh/cs_image/bg_tit_wave.png"></p>
      <br><br>
   <form name="csBoard_delete" action = "http://localhost:8080/dongsuh/csBoard_delete_controller.do" method="post">
      <ul>
         
         <h1 id="font-size50"> 정말로 삭제하시겠습니까??</h1>
      </ul>
      <br><br>
