...
<jsp:include page="../header.jsp"/>
   ...
   <div id="cs_div2">
   <p id = "slash_red">/</p>
   <p id = "cs_title">문의 내역 수정</p>
   <p class="wave"><img src="http://localhost:8080/dongsuh/cs_image/bg_tit_wave.png"></p>
   </div>
   <form name="csBoard_update" action = "http://localhost:8080/dongsuh/csBoard_update_controller.do" method="post"
   ...
   <table id="csBoard_table1">
      ...
      <tr>
         ...
         <a href = "http://localhost:8080/dongsuh/csBoard_list.do?rpage=${rpage}">
         <button type="button"  id="cs_button" class="cs_button">목록으로</button></a>
         <a href = "http://localhost:8080/dongsuh/csBoard_content.do?no=${no}&rpage=${rpage}">
