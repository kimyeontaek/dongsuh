...
<div id="ar3">
    ...
    <div id="contents">
       ...
       <form name="faqformup" action = "http://localhost:8080/dongsuh/faqformup.do">
        <h1> 공지 사항</h1>
<div>
    <table style="margin-left: auto; margin-right: auto;">
        
        <tr>
        <th  maxlength="50" size="90">제목</th>
            <td width="600px">${vo.title}</td>
            </tr>
            
            <tr>
            <th maxlength="2000" style="height:350px;"cols="90" rows="15">내용</th>
