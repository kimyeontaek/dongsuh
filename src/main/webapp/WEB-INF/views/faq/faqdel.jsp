...
<div id="ar3">
    ...
    <div id="contents">
       ...
       <form name="faq_delete" action = "http://localhost:8080/dongsuh/faqdel.do" method="post">
       
         <button type="submit" id="dl" >삭제하기</button>
           <a href ="http://localhost:8080/dongsuh/faqgon.do">
      <button type="button">공지사항으로</button></a>
         </form>
       <!-- form창 종료 -->
       </div>
       </div>
