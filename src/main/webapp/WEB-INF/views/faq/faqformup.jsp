...
<div id="ar3">
    ...
    <div id="contents">
       ...
       <form name="faq_update_check" action = "http://localhost:8080/dongsuh/faq_update_check.do">
        <h1> 수정 사항 입력</h1>
<div>
    <table>
        <tr>
        <th>제목</th>
            <td><input type="text" placeholder="${vo.title}" id="faqTitle" name="title" maxlength="50" size="60" ></td>
            </tr>
            
            <tr>
            <th>내용</th>
            <td><textarea  placeholder="${vo.content}" id="faqcontent"  name="content" maxlength="2000" style="height:350px"cols="60" rows="15" ></textarea></td>
        </tr>
    </table>
    <div>
       ...
       <a href = "http://localhost:8080/dongsuh/faqdel.do?no=${no}">
         <button type="button" id="dl" >삭제하기</button></a>
         <input type="hidden" name = "no" value="${no}">
         
        
         <button type="submit" id="sj"  >수정하기</button>
         </form>
       <!-- form창 종료 -->
       </div>
       </div>
